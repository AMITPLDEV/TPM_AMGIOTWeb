...
{
    public partial class ProcessParameterMasterAGI : System.Web.UI.Page
    {
        ...
        private void ReadOrModifyPage()
        {
            try
            {
                ...
                string accestype = list.Where(x => x.Screen == "AGI Param.").Select(x => x.Value).FirstOrDefault();
                if (accestype == "Read")
                {
        ...
        private void BindControllerLevelData()
        {
            try
            {
                ...
                List<ProcessParameterMasterData> list = DBAccess.getProcessParameterAGIControllerLevelData(ddlControlLvlCNCMake.SelectedValue, ddlControlLvlCNCModel.SelectedValue, "", "");
                int listcountFlag = 0;
                if (list.Count == 0)
                {
                    listcountFlag = 1;
        ...
        protected void btnInsertControllerLevel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //}
                int result;
                DBAccess.insertUpdateProcessParameterAGIControllerData(data, "ControllerLevel", out result);
                if (result == 0)
                {
        ...
        private void BindModelData()
        {
            try
            {
                ...
                List<ProcessParameterMasterData> list = DBAccess.getProcessParameterAGIModelLevelData(data);
                int listcountFlag = 0;
                if (list.Count == 0)
                {
                    listcountFlag = 1;
        ...
        protected void btnInsertModelLvl_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //}
                int result;
                DBAccess.insertUpdateProcessParameterAGIControllerData(data, "ModelLevel", out result);
                if (result == 0)
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "warning", "openErrorModal('Failed to insert record.');", true);
                    return;
        ...
        private void BindMachineLevelData()
        {
            try
            {
                ...
                List<ProcessParameterMasterData> list = DBAccess.getProcessParameterAGIMachineLevelLevelData(data);
                int listcountFlag = 0;
                if (list.Count == 0)
                {
                    listcountFlag = 1;
            ...
            try
            {
                ...
                for (int i = 0; i < gvMAchineLvlData.Rows.Count; i++)
                {
                    ...
                    if (string.Equals("updated", updatedValue, StringComparison.OrdinalIgnoreCase))
                    {
                        ...
                        //}
                        int result;
                        DBAccess.insertUpdateProcessParameterAGIControllerData(data, "MachineLevelParameters", out result);
                        if (result == 0)
                        {
                            ScriptManager.RegisterStartupScript(this, this.GetType(), "warning", "openErrorModal('Failed to update record.');", true);
                            return;
            ...
            try
            {
                ...
                for (int i = 0; i < gvControllerLvlData.Rows.Count; i++)
                {
                    if ((gvControllerLvlData.Rows[i].FindControl("chkDeleteSelection") as CheckBox).Checked)
                    {
                        ...
                        data.ParemeterID = (gvControllerLvlData.Rows[i].FindControl("lblParemeterID") as Label).Text;
                        int result = DBAccess.deleteProcessParameterAGIControllerData(data);
                        if (result == 0)
                        {
            ...
            try
            {
                ...
                for (int i = 0; i < gvMTBModeldata.Rows.Count; i++)
                {
                    if ((gvMTBModeldata.Rows[i].FindControl("chkDeleteSelection") as CheckBox).Checked)
                    {
                        ...
                        data.ParemeterID = (gvMTBModeldata.Rows[i].FindControl("lblParemeterID") as Label).Text;
                        int result = DBAccess.deleteProcessParameterAGIModelData(data);
                        if (result == 0)
                        {
                            ScriptManager.RegisterStartupScript(this, this.GetType(), "warning", "openErrorModal('Failed to delete record.');", true);
                            return;
            ...
            try
            {
                ...
                for (int i = 0; i < gvMAchineLvlData.Rows.Count; i++)
                {
                    if ((gvMAchineLvlData.Rows[i].FindControl("chkDeleteSelection") as CheckBox).Checked)
                    {
                        ...
                        data.ParemeterID = (gvMAchineLvlData.Rows[i].FindControl("lblParemeterID") as Label).Text;
                        int result = DBAccess.deleteProcessParameterAGIMachineData(data);
                        if (result == 0)
                        {
                            ScriptManager.RegisterStartupScript(this, this.GetType(), "warning", "openErrorModal('Failed to delete record.');", true);
                            return;
        ...
        protected void btnModelLvlCopyConfirm_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (System.Web.UI.WebControls.ListItem item in lbModelLvlCopyDistModel.Items)
                {
                    if (item.Selected)
                    {
                        DBAccess.copyModelLevelDataToSelectedModelAGI(srcModel, item.Value, ddlModelLvlCNCMake.SelectedValue, ddlModelLvlCNCModel.SelectedValue, ddlModelLvlMachineType.SelectedValue, ddlModelLvlMTB.SelectedValue);
                    }
                }
            }
            catch (Exception ex)
        ...
        protected void btnMachineLvlCopyConfirm_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (System.Web.UI.WebControls.ListItem item in lbMachineLvlCopyDistID.Items)
                {
                    if (item.Selected)
                    {
                        DBAccess.copyMachineLevelDataToSelectedModelAGI(srcMachineId, item.Value, ddlMachineLvlCompany.SelectedValue, ddlMachineLvlPlant.SelectedValue, ddlMachineLvlCNCMake.SelectedValue, ddlMachineLvlCNCModel.SelectedValue, ddlMachineLvlMTB.SelectedValue, ddlMachineLvlMachineType.SelectedValue, ddlMachineLvlMachineModel.SelectedValue);
                    }
                }
            }
            catch (Exception ex)
