<%@ Page Language="C#" MasterPageFile="~/Unauthenticated.Master" AutoEventWireup="true" CodeBehind="TwoFactorAuthenticationSignIn.aspx.cs" Inherits="NewProject.TwoFactorAuthenticationSignIn" %>
            ...
            <div class="row">
                <div class="col-md-12">
                    Two-Factor Authentication Provider:
                        <asp:DropDownList runat="server" ID="Providers" Style="margin-left: 10px;" />
                    <asp:Button Text="Send OTP" ID="ProviderSubmit" OnClick="ProviderSubmit_Click" CssClass="btn btn-default" runat="server" />
                </div>
            </div>
        </section>
    </asp:PlaceHolder>
